...
def shell(team, targetTeam, teamTable, targetTeamTable, teamFlyingTable, targetTeamFlyingTable):
    ...
    elif parsedCommand[1] == "health": pass
    elif parsedCommand[1] == "kill": pass
    elif parsedCommand[1] == "man": pass
    elif parsedCommand[1] == "freeze": pass
